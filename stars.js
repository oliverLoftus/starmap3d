...
const stars = [
  ...
  new Star("Toliman", -0.495, -0.414, -1.157, 0.9, 13),
  new Star("Rigil Kentaurus", -0.495, -0.414, -1.157, 0.71, 18),
  ...
  new Star("61 Cygni B", 1.986, -1.869, 2.188, 1.309, 9),
  new Star("61 Cygni A", 1.985, -1.87, 2.188, 1.069, 10),
  new Star("Procyon", -1.469, 3.176, 0.32, 0.432, 31),
  new Star("Struve 2398 A", 0.331, -1.75, 3.04, 1.504, 6),
  new Star("Struve 2398 B", 0.331, -1.751, 3.039, 1.561, 5),
  ...
  new Star("Luyten's Star", -1.403, 3.499, 0.345, 1.573, 4),
